...
export default function Document() {
  return (
    <Html lang="en" className="dark">
      <Head>
        <meta charSet="utf-8" />
        <meta name="description" content={process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'Edge AI Local — Private AI. Secure Systems. Edge Intelligence. AI-powered edge computing and security products built on Raspberry Pi.'} />
        <meta name="keywords" content="Edge AI, Raspberry Pi, AI Security Camera, Offline AI, Face Recognition, Privacy AI, Edge Computing" />
        <meta property="og:title" content={process.env.NEXT_PUBLIC_SITE_NAME || 'Edge AI Local'} />
        ...
        <meta property="og:url" content={process.env.NEXT_PUBLIC_SITE_URL || 'https://edgeailocal.in'} />
        <link rel="icon" type="image/png" href="/EdgeAILocal.png" />
