        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 rounded-lg bg-white/10 dark:bg-brand-500/20 border border-brand-500/20 dark:border-brand-500/40 flex items-center justify-center overflow-hidden">
